...
function initializeWispConnection() {
    ...
    wsConnection.onopen = () => {
        // Core validation packet [Version Major: 0x01, Minor: 0x00]
...
function dispatchWispRequestPayload(searchQueryText) {
    ...
    if(targetTracker) {
        targetTracker.textContent = "Query Target: https://html.duckduckgo.com" + explicitNetworkPath;
    }
